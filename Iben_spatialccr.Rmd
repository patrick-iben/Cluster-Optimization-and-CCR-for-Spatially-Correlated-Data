...
#StudyByVillage_noMagoro$village_code == "18_1"| StudyByVillage_noMagoro$village_code == "07_3"| StudyByVillage_noMagoro$village_code == "08_3"|  
...
#Black and white visualization of clustering scheme (if nee)
...
#Black and white
#plot(map, main="Ward-Like Hierarchical Clustering of Size 18 Obtained with alpha=0.6",cex.main=1 )
...
However, while clustering with geographic dissimilarity and strategic weighting during CCR may suffice for optimizing balance on spatial feature (covariate) data, it does not guarantee that the scheme randomly selected at the end of CCR avoids spatial contamination of treatment arms. To do so requires additional methodology, in which only allocation schemes that result in spatial heterogeneity of treatment arms are considered during CCR.
